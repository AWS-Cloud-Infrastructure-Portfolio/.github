...
| [governance-observability-terraform](https://github.com/AWS-Security-Portfolio/logging-monitoring) | Centralized logging and monitoring using CloudTrail, GuardDuty, CloudWatch, Config and Athena.                           |
