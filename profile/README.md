...
| [aws-secure-vpc-terraform](https://github.com/AWS-Security-Portfolio/vpc)                  | AWS VPC architecture with public/private subnets, NAT gateway, bastion host and network segmentation (Terraform).        |
...
| [secure-observability-stack](https://github.com/AWS-Security-Portfolio/logging-monitoring) | Centralized logging and monitoring using CloudTrail, GuardDuty, CloudWatch, Config and Athena.                           |
